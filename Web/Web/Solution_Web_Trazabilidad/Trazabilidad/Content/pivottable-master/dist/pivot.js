  ...
  callWithJQuery(function($) {
    ...
    pivotTableRenderer = function(pivotData, opts) {
      ...
      for (j in colAttrs) {
        ...
        th = document.createElement("th");
        th.className = "pvtAxisLabel head";
        th.textContent = c;
        tr.appendChild(th);
        for (i in colKeys) {
    ...
    $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
      ...
      try {
        ...
        for (x in ref) {
          ...
          unused = $("<td>").addClass('pvtAxisContainer pvtUnused pvtHorizList');
        ...
        $("<td>").addClass('pvtAxisContainer pvtVals').appendTo(tr2).append(aggregator).append(rowOrderArrow).append(colOrderArrow).append($("<br>"));
        $("<td>").addClass('pvtAxisContainer pvtHorizList pvtCols').appendTo(tr2);
          
          
        tr3.append($("<td>").addClass('pvtAxisContainer pvtRows').attr("valign", "top"));
