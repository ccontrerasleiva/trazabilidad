...
function editloc(productId) {
    $.ajax({
        type: 'GET',
        url: '/Locomotora/LoadLocomotoraModal/', // The method name + paramater
        data: { id: productId },
        success: function (result) {
            //console.log(result);
...
function deleteLoc(productId) {
    $.ajax({
        type: 'GET',
        url: '/Locomotora/LoadLocomotoraModalxDel/', // The method name + paramater
        data: { id: productId },
        success: function (result) {
            //console.log(result);
