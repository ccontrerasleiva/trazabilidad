$(function () {
    $(document).ready(function () {
        ...
        $(document/*"#modal-edit"*/).delegate("#modal-editAutoriza form", "submit", function () {
            var form = this;
...
function Create(productId, num_mantenedor) {
    if (num_mantenedor == '1') {
    	url_C = '/Tren/LoadTrenModalGestionDiaria/';         //Agregar Tren Locomotora.
...
function Autoriza(productId, estado) {
    
        url_C = '/Tren/ModalAutoriza/';         //confirma
        resultadoC = '#AutorizaTren';
    

    $.ajax({
        type: 'GET',
        url: '/Tren/ModalAutoriza/',
...
function Edit(productId, num_mantenedor) {
    if (num_mantenedor == '1') {
    	url_E = '/Tren/LoadTrenModalGestionDiariaxHora/';         //Edita la hora reprogramada de Tren
        resultadoE = '#CambiaHoraTren';
    }
    else if (num_mantenedor == '2') {
    	url_E = '/Tren/LoadTrenModalxEditLocGestionDiaria/';     //Editar Locomotora
        resultadoE = '#EditLoc';
...
function EditTrip(productId, num_mantenedor, tipoTrip) {
    if (num_mantenedor == '1') {
    	url_E = '/Tren/LoadTrenModalxEditTripGestionDiaria/';         //Edita Tripulantes
        resultadoE = '#EditTrip';
    }
...
function Delete(productId, num_mantenedor) {
    if (num_mantenedor == '1') {
    	url_D = '/Tren/LoadTrenModalDeleteGestionDiaria/';          //Suprimir Tren
        resultadoD = '#SuprimirTren';
    }
    else if (num_mantenedor == '2') {
        url_D = '/Tren/LoadTrenModalxGestionDiaria/';      //Mantenedor Itinerario.
