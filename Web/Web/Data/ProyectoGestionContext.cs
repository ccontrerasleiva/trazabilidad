namespace Data
{
    ...
    public class ProyectoGestionContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.Configurations.Add(new Entities.ETConvoyCabecera());
            //modelBuilder.Configurations.Add(new Entities.PesoConvoy());
            modelBuilder.Configurations.Add(new Entities.Armado());
            modelBuilder.Configurations.Add(new Entities.MovArmado());

            modelBuilder.Configurations.Add(new Entities.TrazaUbicacionContenedor());
            modelBuilder.Configurations.Add(new Entities.TrazaUbicacionCarro());
            modelBuilder.Configurations.Add(new Entities.TrazaUbicacionLocomotora());


            modelBuilder.Configurations.Add(new Entities.Paso());
            //modelBuilder.Configurations.Add(new Entities.IGLogArmado());
        }
